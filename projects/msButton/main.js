...
var randomY = Math.round(Math.random()*((window.innerHeight-100)-101))+100;
var randomSpace = Math.round(Math.random()*100) + 80
console.log(randomY);
for(var i = 0; i < 3; i++){
  var btn = document.createElement("BUTTON");
  btn.style.position = "fixed";
  btn.tabIndex="-1";
  btn.posX = window.innerWidth/1.8 - i*randomSpace;
  btn.posY = randomY;
